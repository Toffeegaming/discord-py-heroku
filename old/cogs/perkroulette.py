...
class Roulette(interactions.Extension):
    ...
    # async def modify_Perks(self,ctx: interactions.CommandContext,character,mode):
    ...
    # async def PerkMaker(self,ctx: interactions.CommandContext, mode,prev_msg=None):
    #     id = ctx.author_id
    ...
    #     ],
    #     guild_ids=guild_ids)
    # async def _AddSurvivor(self,ctx: interactions.CommandContext,naam: str):
    #     self.check_connection()
    ...
    #     ],
    #     guild_ids=guild_ids)
    # async def _AddSurvivor2(self,ctx: interactions.CommandContext,naam: str):
    #     self.check_connection()
    #     await self.modify_Perks(ctx,naam,'add')

    # @cog_ext.cog_subcommand(base="Roulette", subcommand_group="survivor", name="list",guild_ids=guild_ids)
    # async def _Roulette_survivor_list(self, ctx: interactions.CommandContext):
    #     await ctx.send("Test")
