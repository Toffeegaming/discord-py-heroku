...
class Bonk(Cog):
    ...
    @interactions.extension_command( name='Bonk', description='Bonk the horny people', guild_ids=guild_ids,
        options=[
            create_option(
                    name="victim",
    ...
    async def _Bonk(self,ctx: interactions.CommandContext, victim=None):
        if victim is None:
